...
void main() {
  ...
  zGoldenTest(
    "When setting a custom icon, the icon should be displayed -> Error type",
    goldenFileName: "zup_snack_bar_error_with_custom_icon",
    (tester) async {
      await tester.pumpDeviceBuilder(
        await goldenBuilder(customIcon: const Icon(Icons.add), type: ZupSnackBarType.error),
      );
    },
  );

  zGoldenTest(
    "When setting a custom icon, the icon should be displayed -> Info type",
    goldenFileName: "zup_snack_bar_info_with_custom_icon",
    (tester) async {
      await tester.pumpDeviceBuilder(
        await goldenBuilder(customIcon: const Icon(Icons.add), type: ZupSnackBarType.info),
      );
    },
  );

  zGoldenTest(
    "When setting a custom icon, the icon should be displayed -> Success type",
    goldenFileName: "zup_snack_bar_success_with_custom_icon",
    (tester) async {
      await tester.pumpDeviceBuilder(
  ...
  zGoldenTest(
    "When setting the show close icon to false, it should not show the close icon -> Error type",
    goldenFileName: "zup_snack_bar_error_no_close_icon",
    (tester) async {
  ...
  zGoldenTest(
    "When setting the show close icon to false, it should not show the close icon -> Info type",
    goldenFileName: "zup_snack_bar_info_no_close_icon",
    (tester) async {
  ...
  zGoldenTest(
    "When setting the show close icon to false, it should not show the close icon -> Success type",
    goldenFileName: "zup_snack_bar_success_no_close_icon",
    (tester) async {
  ...
  zGoldenTest(
    ...
    goldenFileName: "zup_snack_bar_max_width_set",
    (tester) async {
    ...
    (tester) async {
      await tester.pumpDeviceBuilder(
        await goldenBuilder(
          ...
          helperButton: (title: "Helper button title", onButtonTap: () {}),
  ...
  zGoldenTest("When clickint the helper button of the snackBar, the callback should be called", (tester) async {
    bool callbackCalled = false;

    await tester.pumpDeviceBuilder(
      await goldenBuilder(
        message: "Helper butto test ",
        helperButton: (title: "Helper button title", onButtonTap: () => callbackCalled = true),
        type: ZupSnackBarType.success,
      ),
    );

    await tester.pumpAndSettle();
    await tester.tap(find.byKey(const Key("helper-button-snack-bar")).first.first);
    await tester.pumpAndSettle();
