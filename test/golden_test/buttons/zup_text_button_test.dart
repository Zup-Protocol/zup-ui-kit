...
void main() {
  Future<DeviceBuilder> goldenBuilder(
      ...
      Widget? icon,
      bool alignLeft = true,
      bool applyColorsToIcon = true}) async {
  ...
  zGoldenTest(
    "Zup Text Button Default",
    goldenFileName: "zup_text_button",
    (tester) async {
      await tester.pumpDeviceBuilder(await goldenBuilder(onPressed: () {}));
    },
  );

  zGoldenTest("When the onPressed is null, it should be in the disabled state",
      goldenFileName: "zup_text_button_disabled", (tester) async {
  ...
  zGoldenTest(
    ...
    (tester) async {
      await tester.pumpDeviceBuilder(
        await goldenBuilder(title: "Icon", onPressed: () {}, icon: const Icon(Icons.add)),
      );
    },
  );
  ...
  zGoldenTest(
      ...
      goldenFileName: "zup_text_button_with_icon_disabled", (tester) async {
    await tester.pumpDeviceBuilder(
      await goldenBuilder(title: "Icon", onPressed: null, icon: const Icon(Icons.add)),
    );
  });

  zGoldenTest("When the applyColorsToIcon is false, it should keep the icon color as it is",
      goldenFileName: "zup_text_button_different_icon_color", (tester) async {
    await tester.pumpDeviceBuilder(
      await goldenBuilder(
          title: "Icon",
          onPressed: () {},
  ...
  zGoldenTest("When hovering the button, it should be in the hovered state", goldenFileName: "zup_text_button_hover",
    ...
    await tester.hover(find.byType(ZupTextButton));
    await tester.pumpAndSettle();
  });

  zGoldenTest("When hovering the button, and it has an Icon, it should resize the icon",
      goldenFileName: "zup_text_button_hover_icon", (tester) async {
    await tester.pumpDeviceBuilder(
  ...
  zGoldenTest("When clicking the button, it should be in the pressed state", (tester) async {
    ...
    await tester.tap(find.byType(ZupTextButton));
    await tester.pumpAndSettle();
