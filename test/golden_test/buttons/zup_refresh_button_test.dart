...
void main() {
  ...
  zGoldenTest("When passing icon color to the zup refresh button, its color should change",
      goldenFileName: "zup_refresh_button_custom_icon_color", (tester) async {
    await tester.pumpDeviceBuilder(await goldenBuilder(iconColor: Colors.green));
  });

  zGoldenTest("When passing a higher size to the zup refresh button, it should be applied",
      goldenFileName: "zup_refresh_button_size", (tester) async {
