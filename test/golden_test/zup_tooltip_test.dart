...
void main() {
  Future<DeviceBuilder> goldenBuilder({
    ...
    String? helperButtonTitle,
      ...
      await goldenDeviceBuilder(ZupTooltip(
        message: message,
  ...
  zGoldenTest("When not hovering the tooltip child, it should not show any tooltip message",
      goldenFileName: "zup_tooltip_not_hovered", (tester) async {
    await tester.pumpDeviceBuilder(await goldenBuilder());
  });

  zGoldenTest("When hovering the tooltip child, it should show the tooltip message",
      goldenFileName: "zup_tooltip_hovered", (tester) async {
    await tester.pumpDeviceBuilder(await goldenBuilder());
  ...
  zGoldenTest("When setting the leading icon, it should be applied visually on hover",
      goldenFileName: "zup_tooltip_with_leading_icon", (tester) async {
  ...
  zGoldenTest("When setting the trailing icon, it should be applied visually on hover",
      goldenFileName: "zup_tooltip_with_trailing_icon", (tester) async {
  ...
  zGoldenTest("When setting the helper button title, it should be displayed on hover",
      goldenFileName: "zup_tooltip_with_helper_button", (tester) async {
  ...
  zGoldenTest("When the text is long, but the max width is less than the text, it should wrap the text",
      goldenFileName: "zup_tooltip_long_text_short_max_width", (tester) async {
    await tester.pumpDeviceBuilder(
      await goldenBuilder(
          maxWidth: 100,
          message:
  ...
  zGoldenTest(
      ...
      goldenFileName: "zup_tooltip_long_text_long_max_width", (tester) async {
    await tester.pumpDeviceBuilder(
      await goldenBuilder(
          maxWidth: 1000,
          message:
